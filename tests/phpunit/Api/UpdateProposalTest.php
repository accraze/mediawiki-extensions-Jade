 ...
 * @group Jade
 *
 * @coversDefaultClass Jade\Api\UpdateProposal
 */
class UpdateProposalTest extends ApiTestCase {
	 ...
	 * @covers ::execute
	 */
	public function testUpdateProposal_sucess() {
		...
		$result = $this->doApiRequestWithToken( [
			'action' => 'jadeupdateproposal',
			'title' => $title,
			'facet' => 'editquality',
			'labeldata' => $labeldata,
			'notes' => 'this is an update',
			'comment' => 'updating this proposal'
		] );
		...
		$this->assertSame( $proposals[0]['notes'], 'this is an update' );
	}
